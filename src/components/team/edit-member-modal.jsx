        ...
        <form onSubmit={handleSubmit} className="p-6 space-y-4">
          <div className="space-y-1">
            <label className="text-sm font-medium text-foreground flex items-center gap-2">
              <Mail size={16} /> Email Address (Cannot be changed)
            </label>
            <Input
              disabled
              value={member.email}
              className="mt-1 bg-muted cursor-not-allowed opacity-80"
            />
          </div>
          ...
          <div className="space-y-1">
            ...
            <p className="text-xs text-muted-foreground mt-1">
              Only provide a value if you want to change the member's password.
            </p>
          </div>
